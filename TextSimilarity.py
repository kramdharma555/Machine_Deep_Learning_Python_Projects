...
df = pd.read_csv("D:\\VU\\EthirNeechal\\trial\\temp_change_text_reg-master\\text_similarity_scores.csv")


#uncomment this!
f = open('D:\\VU\\EthirNeechal\\trial\\temp_change_text_reg-master\\train_docs_sec7.txt', 'w+') 
...
basepath1 = "D:\\VU\\EthirNeechal\\trial\\temp_change_text_reg-master"
...
#input corpus
train_corpus = open("D:\\VU\\EthirNeechal\\trial\\temp_change_text_reg-master\\train_docs_sec7.txt", 'r').readlines()

#output model
saved_path = "D:\\VU\\EthirNeechal\\trial\\temp_change_text_reg-master\\output.bin"
...
df.to_csv('D:\\VU\\EthirNeechal\\trial\\temp_change_text_reg-master\\text_similarity_scores.csv')
